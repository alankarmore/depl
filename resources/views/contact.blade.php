...
@section('content')
    ...
    <section class="inner-about margin-top134">
        ...
        <!-- Start Google Map -->
        <section class="margin-top40 margin-bottom40" id="google-map">
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var map_area_lat = map_area_lng = "";
            @if(isset($officesArray[0]['google_map']['lat']))
                var map_area_lat = {{$officesArray[0]['google_map']['lat']}}+';'
            @endif
            @if(isset($officesArray[0]['google_map']['lng']))
                var map_area_lat = {{$officesArray[0]['google_map']['lng']}}+';'
            @endif
