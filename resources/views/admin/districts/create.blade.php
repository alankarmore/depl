...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add New District</h1>
        </div>
    </div><!--/.row-->
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <form role="form" name="frmDistrict" id='frmDistrict' action="{{route('districts.save')}}" method="POST">
                            <div class="form-group">
                                <label>State Name</label>
                                <select name="states_id" id="states_id" class="form-control">
                                    <option value="0">Select State</option>
                                    @foreach($states as $state)
                                        <option value="{{$state->id}}" @if(old('states_id') == $state->id) selected="selected" @endif>{{ucfirst($state->name)}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="District Name" name="name" id="name" value="{{old('name')?old('name'):''}}" maxlength="150">
