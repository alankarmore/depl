                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <form role="form" name="frmAlbum" id='frmAlbum' enctype="multipart/form-data" action="{{route('album.update',array('id' => $album->id))}}" method="POST">
                                <div class="form-group">
                                    <label>Album Name</label>
                                    <input type="text" name="title" id="title" value="{{$album->name}}"  class="form-control"/>
                                ...
                                <div id="albumImages">
                                    @if($album->albumImages->count() > 0)
                                        @foreach($album->albumImages as $albumImage)
                                            <span id="{{$albumImage->id}}">
                                                <img src="{{asset('uploads/albums')}}/{{$albumImage->image}}" width="100" height="100">
                                                <a href="javascript:void(0);" class="removeImage" data-id="{{$albumImage->id}}">
