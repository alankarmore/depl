...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Add New Cities</li>
        </ol>
    </div><!--/.row-->
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <form role="form" name="frmState" id='frmState' action="{{route('city.save')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="City Name" name="name" id="name" value="{{old('name')?old('name'):''}}" maxlength="100">
