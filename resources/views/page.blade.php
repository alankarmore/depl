                        ...
                        <div class="project-conten">
                            ...
                            <div class="project-slider">
                                ...
                                <div class="single-slide">
                                    <div class="col-md-4 col-sm-12 col-xs-12"><div class="project-thumb"><img class="project-thumb" src="assets/images/project-thumb1.jpg" alt="img"></div></div>
                                    <div class="col-md-8 col-sm-12 col-xs-12"><div class="project-details">
                                            <h2>{{ucfirst($project->title)}}</h2>
                                            <div class="about-project">STATE: <span class="text-green">{{ucfirst($project->state)}}</span> | PROJECT TYPE: <span class="text-green">{{ucfirst($project->project_type)}}</span> | COMPANY: <span class="text-green">{{ucwords($project->company)}}</span> | Length: <span class="text-green">{{ucfirst($project->length)}}</span></div>
                                            <p>
